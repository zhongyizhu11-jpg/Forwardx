...
const tables: TableDef[] = [
  {
    ...
    columns: [
      ...
      c("maxProxyInbounds", "int", { notNull: true, default: 0 }),
      ...
      c("manualMaxProxyInbounds", "int", { notNull: true, default: 0 }),
