 ...
 *
 *   - **总开关**在这一页 —— 但这一页原来侧边栏里点不到，全站零链接，只能手敲 URL。
 *   - **资源定价**在套餐管理的一个 tab 里，那里又刻意不渲染总开关。
 *   - **谁能用**在用户管理 → 编辑用户 → 两个多选框里。
 *   - **租户余额**在账单与兑换。
 *
 * 四处都对了才真的收得到钱，错一处就是静悄悄不生效，而没有任何一个地方告诉你缺哪
 * 一环。所以这一页要回答的是一句话：**「我这套配好了没有，还差什么」**。
 *
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            <h1 className="text-2xl font-semibold tracking-tight">流量计费</h1>
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            ...
            {/*
              新增按钮要留在这一页。下面那个组件的「新增」原来长在它自己的 header 里，
              而这一页两个 header 都关掉了（总开关已经在上面，不要两个）—— 不补这一个，
              这一页就成了只能看不能加。
            */}
        ...
        {/*
          ...
          原来总开关在界面上根本点不到，人配完了价等账单，等到的是 0。
        */}
        {!isLoading && !enabled ? (
        ...
        <Card>
          <CardContent className="divide-y divide-border/60 p-4 sm:p-5">
            <div className="flex items-center gap-2 pb-2">
              ...
              <h2 className="text-sm font-semibold">配到哪一步了</h2>
            </div>
            {isLoading ? (
