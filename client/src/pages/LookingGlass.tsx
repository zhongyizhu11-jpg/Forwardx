  ...
  return (
    <Card className="relative flex h-[480px] min-w-0 flex-col overflow-hidden border-border bg-card sm:h-[520px] xl:h-[560px]">
      ...
      <CardContent className="min-h-0 flex-1 p-0">
        <pre className="terminal-scrollbar h-full min-h-0 overflow-auto bg-neutral-950 px-4 py-4 font-mono text-xs leading-6 text-neutral-100">
          {output}
        </pre>
      </CardContent>
    </Card>
  ...
  return (
    <Card className="relative flex h-[560px] min-w-0 flex-col overflow-hidden border-border bg-card sm:h-[600px] xl:h-[640px]">
      ...
      <CardContent className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden p-4">
        ...
        <pre className="terminal-scrollbar min-h-0 flex-1 overflow-auto rounded-lg bg-neutral-950 px-4 py-3 font-mono text-xs leading-6 text-neutral-100">
          {output}
        </pre>
      </CardContent>
    </Card>
